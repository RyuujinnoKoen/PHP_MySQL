...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $query = "INSERT INTO students(name, last_name, date_of_birth, email) VALUES('$name', '$lastName', '$dateOfBirth', '$email')"; "INSERT INTO student_subjects(subject) VALUES ('$studentSubject')";
